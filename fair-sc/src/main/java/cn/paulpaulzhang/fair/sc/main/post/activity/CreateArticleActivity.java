...
public class CreateArticleActivity extends FairActivity implements IMentionTopicListener {
    ...
    void doSend() {
        ...
        if (Objects.requireNonNull(mTitle.getText()).toString().isEmpty()) {
            Toasty.info(this, "标题不能为空哦！", Toasty.LENGTH_SHORT).show();
            return;
        }
                ...
                RestClient.builder()
                        ...
                        .success(r -> {
                            ...
                            if (TextUtils.equals(result, "ok")) {
                                Toasty.success(CreateArticleActivity.this, "发表成功", Toasty.LENGTH_SHORT).show();
                                finish();
                            } else {
                                Toasty.error(CreateArticleActivity.this, "发表失败，请重试", Toasty.LENGTH_SHORT).show();
                            }
                        })
                        .error((code, msg) -> {
                            FairLoader.stopLoading();
                            Toasty.error(CreateArticleActivity.this, "发表失败，请重试 " + code, Toasty.LENGTH_SHORT).show();
                            FairLogger.d(code);
                        })
                        .build()
                        .post();
