 ...
 * 描述：
 */
public class ShoppingCartActivity extends FairActivity {

    @BindView(R2.id.toolbar)
    MaterialToolbar mToolbar;

    @BindView(R2.id.srl_cart)
    ...
    private void initRecycler() {
        mAdapter = new ShoppingCartAdapter(R.layout.item_user_cart, new ArrayList<>());
